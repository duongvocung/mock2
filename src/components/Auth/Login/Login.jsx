...
function Login() {
    ...
    const _onSubmitForm = (value) => {
        login(value.email, value.password).then(() => {
            if (localStorage.getItem("role") === "admin") navigate("/dashboard");
                ...
                context.setAuth({forgotPassword: false, login: false , register: false})
            }
        });
    };
    ...
    const _showRegister = () => {
        context.setAuth({forgotPassword: false, login: false , register: true})
    };
    const _showForgotPass = () => {
        context.setAuth({forgotPassword: true, login: false , register: false})
    };
